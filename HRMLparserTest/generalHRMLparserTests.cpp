...
class GeneralHRMLparserTests : public ::testing::Test {
protected:
	void SetUp() override {
...
TEST_F(GeneralHRMLparserTests, parseSimpleDocNewLinesTest)
{
	vector<string> lines;
...
TEST_F(GeneralHRMLparserTests, parseSimpleDocOneLineTest)
{
	vector<string> lines;
...
TEST_F(GeneralHRMLparserTests, parseBigDocNewLinesTest)
{
	vector<string> lines;
...
TEST_F(GeneralHRMLparserTests, parseBigDocOneLineTest)
{
	vector<string> lines;
